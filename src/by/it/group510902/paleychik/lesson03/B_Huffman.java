...
public class B_Huffman {
    ...
    String decode(InputStream inputStream) {
        ...
        int length = scanner.nextInt(); // можно не использовать
        ...
        for (char bit : encoded.toCharArray()) {
            ...
            if (codeMap.containsKey(buffer.toString())) {
                result.append(codeMap.get(buffer.toString()));
                buffer.setLength(0); // очистка быстрее чем buffer = ""
            }
        }
